...
import Particles from "./Particles"; // Assuming you have this file in the same directory
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (rect.top <= window.innerHeight && rect.bottom >= 0) {
        setIsInViewport(true); // Trigger animation if in the viewport
      } else {
        ...
        {projects.map((project, index) => (
          ...
          >
            ...
            <div className="w-full sm:w-5/12 flex justify-center">
              <motion.div
                className="bg-gray-800 rounded-lg shadow-lg overflow-hidden relative transition-all w-2/3 sm:w-80 md:w-96 group" // Adjust width here
                whileHover={{
                  scale: 1.05,
