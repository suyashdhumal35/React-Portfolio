...
>
  <div className="container mx-auto pb-20 md:px-4 flex flex-col-reverse md:flex-row items-center h-full">
    {/* Left Content */}
    <div
      className={`md:w-1/2 w-full flex flex-col items-start space-y-2 transform transition-all duration-500 z-0 flex-1 ${
    ...
    {/* Image Section */}
    <div
      className={`w-full md:w-3/5 sm:h-auto h-2/3 transform transition-all duration-500 flex-1 ${
    ...
    >
      <img
        src={manimg}
        alt="Suyash Dhumal"
        className={`w-full max-h-[80vh] object-cover sm:object-contain object-center rounded-md shadow-lg ${
          isMobile ? "mt-8" : ""
        }`}
      />
    </div>
